		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "List of games",
									"targetURL": "#eduapbezsd042gameapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"eduapbezsd042gameapp-display": {
								"semanticObject": "eduapbezsd042gameapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=edu.ap.be.zsd042gameapp",
									"url": sap.ui.require.toUrl("edu/ap/be/zsd042gameapp")
								}
							}
						}
					}
